        ...
        <div className="space-y-6">
          <section className="border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2">
              ...
              <label className="text-sm font-bold text-slate-700">
                Primary Color
                <input
                  className="mt-2 h-12 w-full border border-slate-300 bg-white px-2"
                  defaultValue="#047857"
                  name="primary_color"
                  type="color"
                />
          ...
          <section className="border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <Link
                className="border border-slate-200 bg-slate-50 p-5 transition hover:border-emerald-300 hover:bg-emerald-50"
