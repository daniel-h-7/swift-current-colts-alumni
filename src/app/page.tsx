          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-lg text-sm font-semibold leading-6 text-gray-400">
                Feature current projects, track progress, and send supporters
                straight into the giving flow.
              </p>
            </div>
            ...
            <div className="flex snap-x snap-mandatory gap-5 overflow-x-auto pb-2">
              {siteContent.fundraisingCampaigns.map((campaign) => (
                <article
                  className="grid min-w-full snap-start gap-6 border border-white/15 bg-[linear-gradient(135deg,rgba(39,39,42,0.94),rgba(9,9,11,0.98))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] md:grid-cols-[1.15fr_0.85fr] md:p-8"
                  key={campaign.title}
                >
                  <div>
                    ...
                    {campaign.description ? (
                      <p className="mt-5 max-w-2xl text-sm font-semibold leading-7 text-gray-400 md:text-base">
                        {campaign.description}
                      </p>
                    ) : null}
                  </div>

                  <div className="flex flex-col justify-between border border-white/10 bg-black/35 p-5">
                    <div>
